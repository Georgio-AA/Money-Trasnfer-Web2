...
<div class="stat-card clickable">
<a href="{{ route('admin.transfers.index') }}?status=pending,processing">
<h3>Active Transfers</h3>
<div class="value">{{ $stats['active_transfers'] }}</div>
</a>
</div>
<div class="stat-card">
...
<div class="subtext" style="margin-top: 8px; opacity: 0.9;">From {{ $revenueStats['completed_count'] }} completed transfers</div>
</div>
<div class="revenue-card green">
<h3>Transfer Volume</h3>
<div class="value">${{ number_format($revenueStats['total_volume'], 2) }}</div>
...
<div class="count">{{ $transferStats['pending'] }}</div>
<div class="label">Pending</div>
</div>
<div class="status-stat processing">
<div class="count">{{ $transferStats['processing'] }}</div>
<div class="label">Processing</div>
</div>
<div class="status-stat completed">
<div class="count">{{ $transferStats['completed'] }}</div>
<div class="label">Completed</div>
</div>
<div class="status-stat failed">
<div class="count">{{ $transferStats['failed'] }}</div>
<div class="label">Failed</div>
</div>
<div class="status-stat cancelled">
<div class="count">{{ $transferStats['cancelled'] }}</div>
...
type: 'line',
data: {
labels: @json(array_column($userGrowth, 'month')),
datasets: [{
label: 'New Users',
data: @json(array_column($userGrowth, 'count')),
borderColor: '#3b82f6',
...
type: 'bar',
data: {
labels: @json(array_column($transferVolume, 'month')),
datasets: [{
label: 'Transfer Volume ($)',
data: @json(array_column($transferVolume, 'volume')),
