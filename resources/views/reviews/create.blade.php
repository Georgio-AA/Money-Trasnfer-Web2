        ...
        <form action="{{ route('reviews.store') }}" method="POST" class="review-form">
            ...
            <div class="transfer-info-card">
                ...
                <div class="transfer-details">
                    ...
                    <p><strong>Date:</strong> {{ $transfer->created_at->format('M d, Y') }}</p>
                    <p><strong>Status:</strong> <span class="status-completed">{{ ucfirst($transfer->status) }}</span></p>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="comment" id="comment" rows="6" required placeholder="Tell us about your experience... (minimum 10 characters)">{{ old('comment') }}</textarea>
