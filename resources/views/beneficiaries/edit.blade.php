...
<section class="form-section">
    <div class="container">
        ...
        <form method="POST" action="{{ route('beneficiaries.update', $beneficiary->id) }}" class="beneficiary-form">
            @csrf
            @method('PUT')
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="phone_number" id="phone_number" value="{{ old('phone_number', $beneficiary->phone_number) }}" required placeholder="+1234567890">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email', $beneficiary->email) }}" placeholder="email@example.com">
                    @error('email')
                        <span class="error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="relationship" id="relationship">
                        ...
                        <option value="family" {{ old('relationship', $beneficiary->relationship) == 'family' ? 'selected' : '' }}>Family</option>
                        <option value="friend" {{ old('relationship', $beneficiary->relationship) == 'friend' ? 'selected' : '' }}>Friend</option>
                        <option value="business" {{ old('relationship', $beneficiary->relationship) == 'business' ? 'selected' : '' }}>Business Partner</option>
                        <option value="employee" {{ old('relationship', $beneficiary->relationship) == 'employee' ? 'selected' : '' }}>Employee</option>
                        <option value="other" {{ old('relationship', $beneficiary->relationship) == 'other' ? 'selected' : '' }}>Other</option>
                    </select>
                    @error('relationship')
                        <span class="error">{{ $message }}</span>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <select name="country" id="country" required>
                        ...
                        @foreach($countries as $code => $name)
                            <option value="{{ $code }}" {{ old('country', $beneficiary->country) == $code ? 'selected' : '' }}>
                                {{ $name }} ({{ $code }})
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="city" id="city" value="{{ old('city', $beneficiary->city) }}" placeholder="Enter city">
                    @error('city')
                        <span class="error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group full-width">
                    ...
                    <input type="text" name="address" id="address" value="{{ old('address', $beneficiary->address) }}" placeholder="Street address">
                    @error('address')
                        <span class="error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="postal_code" id="postal_code" value="{{ old('postal_code', $beneficiary->postal_code) }}" placeholder="Postal code">
                    @error('postal_code')
                        <span class="error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="preferred_payout_method" id="preferred_payout_method" required>
                        ...
                        @foreach($payoutMethods as $key => $label)
                            <option value="{{ $key }}" {{ old('preferred_payout_method', $beneficiary->preferred_payout_method) == $key ? 'selected' : '' }}>
                                {{ $label }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group" id="wallet-fields" style="display:none;">
                    ...
                    <input type="text" name="mobile_wallet_number" id="mobile_wallet_number" value="{{ old('mobile_wallet_number', $beneficiary->mobile_wallet_number) }}" placeholder="Enter wallet number">
                ...
                <div class="form-group" id="wallet-provider-field" style="display:none;">
                    ...
                    <select name="mobile_wallet_provider" id="mobile_wallet_provider">
                        ...
                        <option value="gcash" {{ old('mobile_wallet_provider', $beneficiary->mobile_wallet_provider) == 'gcash' ? 'selected' : '' }}>GCash</option>
                        <option value="paymaya" {{ old('mobile_wallet_provider', $beneficiary->mobile_wallet_provider) == 'paymaya' ? 'selected' : '' }}>PayMaya</option>
                        <option value="mpesa" {{ old('mobile_wallet_provider', $beneficiary->mobile_wallet_provider) == 'mpesa' ? 'selected' : '' }}>M-Pesa</option>
                        <option value="bkash" {{ old('mobile_wallet_provider', $beneficiary->mobile_wallet_provider) == 'bkash' ? 'selected' : '' }}>bKash</option>
                        <option value="easypaisa" {{ old('mobile_wallet_provider', $beneficiary->mobile_wallet_provider) == 'easypaisa' ? 'selected' : '' }}>Easypaisa</option>
                        <option value="jazzcash" {{ old('mobile_wallet_provider', $beneficiary->mobile_wallet_provider) == 'jazzcash' ? 'selected' : '' }}>JazzCash</option>
                        <option value="other" {{ old('mobile_wallet_provider', $beneficiary->mobile_wallet_provider) == 'other' ? 'selected' : '' }}>Other</option>
                    </select>
