    ...
    <div class="support-grid">
        ...
        <div class="card">
            ...
            <div id="tickets-tab" class="tab-content active">
                <div class="tickets-list">
                    @forelse($tickets as $ticket)
                        <div class="ticket-item {{ $ticket['priority'] }}" onclick="window.location.href='{{ route('support.ticket', $ticket['id']) }}'">
            ...
            <div id="create-tab" class="tab-content">
                <form action="{{ route('support.create-ticket') }}" method="POST">
                    @csrf
...
async function sendMessage() {
    ...
    try {
        const response = await fetch('{{ route('support.chatbot') }}', {
            method: 'POST',
            headers: {
