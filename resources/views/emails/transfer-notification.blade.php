    ...
    <div class="container">
        ...
        <div class="content">
            <div class="greeting">
                ...
                <p>Great news! You have received a money transfer from <strong>{{ $senderName }}</strong> via SWIFTPAY.</p>
            </div>

            <div class="transfer-details">
                <div class="detail-row">
                    <span class="detail-label">Amount Received:</span>
                    <span class="detail-value amount-highlight">{{ $currency }} {{ number_format($amount, 2) }}</span>
                </div>
                <div class="detail-row">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ date('F d, Y \a\t g:i A') }}</span>
                </div>
            </div>
