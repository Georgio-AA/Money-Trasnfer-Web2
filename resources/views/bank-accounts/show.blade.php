...
<section class="account-details">
    <div class="container">
            ...
            <div class="account-card">
                ...
                <div class="account-info">
                    ...
                    <div class="info-row">
                        ...
                        <span>****{{ substr($bankAccount->account_number, -4) }}</span>
                    </div>
                    
                    <div class="info-row">
                        <label>Account Type:</label>
                        <span>{{ ucfirst($bankAccount->account_type) ?? 'Not specified' }}</span>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <span>{{ $bankAccount->created_at->format('F j, Y \a\t g:i A') }}</span>
                    </div>
                    
                    @if($bankAccount->updated_at != $bankAccount->created_at)
                        <div class="info-row">
                            <label>Last Updated:</label>
                            <span>{{ $bankAccount->updated_at->format('F j, Y \a\t g:i A') }}</span>
                        </div>
                    @endif
                ...
                @if(!$bankAccount->is_verified)
                    <div class="verification-prompt">
                        <div class="prompt-content">
                            ...
                            <a href="{{ route('bank-accounts.verify-form', $bankAccount) }}" class="btn btn-primary">Verify Now</a>
                        </div>
                    </div>
                @endif

                <div class="actions">
                    <a href="{{ route('bank-accounts.edit', $bankAccount) }}" class="btn btn-secondary">Edit Account</a>
                    @if(!$bankAccount->is_verified)
                        <a href="{{ route('bank-accounts.verify-form', $bankAccount) }}" class="btn btn-primary">Verify Account</a>
                    @endif
        ...
        <div class="back-action">
            <a href="{{ route('bank-accounts.index') }}" class="btn btn-outline">← Back to All Accounts</a>
        </div>
    </div>
</section>
