...
<section class="bank-accounts">
    <div class="container">
        <div class="account-header">
            ...
            <a href="{{ route('bank-accounts.create') }}" class="btn btn-primary">Add New Account</a>
        </div>
                ...
                @foreach($bankAccounts as $account)
                    <div class="account-card">
                        ...
                        <div class="account-actions">
                            <a href="{{ route('bank-accounts.show', $account) }}" class="btn btn-secondary">View</a>
                            <a href="{{ route('bank-accounts.edit', $account) }}" class="btn btn-secondary">Edit</a>
        ...
        @else
            <div class="empty-state">
                ...
                <a href="{{ route('bank-accounts.create') }}" class="btn btn-primary">Add Your First Account</a>
            </div>
        @endif
    </div>
</section>
