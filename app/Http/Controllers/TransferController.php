...
class TransferController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            //amira
            'agent_id' => 'required_if:payout_method,cash_pickup|exists:agents,id',
        ...
        try {
            ...
            // Create the transfer
            //amira
            if ($validated['payout_method'] === 'cash_pickup') {
    ...
    // Record agent cash-in
    \App\Models\AgentTransaction::create([
        'agent_id' => $validated['agent_id'],
        'transfer_id' => $transfer->id,
        'type' => 'cash-in',
        'amount' => $amount,
        'currency' => $validated['target_currency'],
        'status' => 'pending',
    ]);

} else {
    // Normal bank deposit or mobile wallet flow
    $transfer = Transfer::create([
        'sender_id' => $user['id'],
        'beneficiary_id' => $validated['beneficiary_id'],
        'source_currency' => $validated['source_currency'],
