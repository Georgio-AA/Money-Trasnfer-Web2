...
<div class="admin-container">
    ...
    <div class="page-header d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('admin.commissions.report')); ?>" class="full-report-btn">
    ...
    <div class="stat-cards">
        ...
        <div class="stat-card">
            ...
            <div class="stat-value">
                $<?php echo e(number_format($agents->count() ? $agents->sum('total_commission')/$agents->count() : 0,2)); ?>
            ...
            <table class="table table-striped align-middle">
                ...
                <tr>
                    <td>
                        ...
                        <div class="text-muted" style="font-size: 0.75rem;"><?php echo e($agent['user']['email']); ?></div>
                    </td>
                    <td><?php echo e($agent['store_name'] ?? '—'); ?></td>
                    <td><?php echo e($agent['commission_rate']); ?>%</td>
                    <td><?php echo e(ucfirst($agent['commission_type'])); ?></td>

                    <td class="text-end"><?php echo e($agent['total_transfers']); ?></td>
                    <td class="text-end">$<?php echo e(number_format($agent['total_transfer_amount'],2)); ?></td>
                    <td class="text-end">
                        <strong>$<?php echo e(number_format($agent['total_commission'],2)); ?></strong>
                    </td>

                    <td class="text-center"><?php echo e($agent['approved'] ? 'Approved' : 'Pending'); ?></td>

                    <td class="text-center">
                        <a href="<?php echo e(route('admin.commissions.detail', $agent['id'])); ?>" class="btn btn-sm btn-dark">
                            View
                        </a>
                    </td>
                </tr>
