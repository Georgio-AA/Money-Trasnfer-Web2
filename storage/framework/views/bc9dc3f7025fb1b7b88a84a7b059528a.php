...
<form method="POST" action="<?php echo e(route('admin.users.destroy', $user->id)); ?>" onsubmit="return confirm('Are you sure you want to delete this user?');">
<?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\money-transfer\WebProject\resources\views/admin/users/show.blade.php ENDPATH**/ ?>