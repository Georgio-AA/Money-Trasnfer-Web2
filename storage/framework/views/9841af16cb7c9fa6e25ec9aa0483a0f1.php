...
<section class="swiftpay-card-section">
    <div class="card-container">
        <div class="card-content">
            ...
            <?php if(session()->has('user')): ?>
                <a href="<?php echo e(route('card.request.create')); ?>" class="card-cta-btn">Request Your Card Now</a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="card-cta-btn">Login to Request Card</a>
            <?php endif; ?>
        </div>
...
<section class="store-section">
    <div class="store-container">
        <div class="store-content">
            ...
            <?php if(session()->has('user')): ?>
                <a href="<?php echo e(route('store.index')); ?>" class="store-cta-btn">Browse Store Now</a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="store-cta-btn">Login to Access Store</a>
            <?php endif; ?>
        </div>
...
<?php /**PATH C:\XAMPP\htdocs\money-transfer2\WebProject\resources\views/index.blade.php ENDPATH**/ ?>