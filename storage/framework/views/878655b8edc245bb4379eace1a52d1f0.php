...
<div class="support-container">
    <a href="<?php echo e(route('support.index')); ?>" class="back-link">← Back to Support</a>
    ...
    <div class="ticket-card">
        <div class="ticket-header">
            <h1 class="ticket-title"><?php echo e($ticket['subject']); ?></h1>
            <div class="ticket-meta">
                <div class="ticket-meta-item">
                    <strong>Ticket ID:</strong> <?php echo e($ticket['id']); ?>

                </div>
                <div class="ticket-meta-item">
                    <strong>Status:</strong>
                    <span class="ticket-status-badge <?php echo e($ticket['status']); ?>"><?php echo e(ucfirst($ticket['status'])); ?></span>
                </div>
                <div class="ticket-meta-item">
                    <strong>Priority:</strong>
                    <span class="priority-badge <?php echo e($ticket['priority']); ?>"><?php echo e(ucfirst($ticket['priority'])); ?></span>
                </div>
                <div class="ticket-meta-item">
                    <strong>Category:</strong> <?php echo e(ucfirst(str_replace('_', ' ', $ticket['category']))); ?>

                </div>
                <div class="ticket-meta-item">
                    <strong>Created:</strong> <?php echo e(\Carbon\Carbon::parse($ticket['created_at'])->format('M d, Y h:i A')); ?>
        ...
        <div class="messages-section">
            <h3>Messages (<?php echo e(count($ticket['messages'])); ?>)</h3>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $ticket['messages']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="message <?php echo e($message['from'] === 'admin' ? 'admin' : ''); ?>">
                    <div class="message-header">
                        <span class="message-sender">
                            <?php echo e($message['from'] === 'admin' ? '👨‍💼 Support Team' : '👤 ' . $message['name']); ?>

                        </span>
                        <span class="message-time"><?php echo e(\Carbon\Carbon::parse($message['timestamp'])->format('M d, Y h:i A')); ?></span>
                    </div>
        ...
        <?php if($ticket['status'] !== 'closed'): ?>
            <div class="reply-form">
                <form action="<?php echo e(route('support.add-message', $ticket['id'])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                ...
                <form action="<?php echo e(route('support.close-ticket', $ticket['id'])); ?>" method="POST" style="display: inline; margin-top: 15px;" onsubmit="return confirm('Are you sure you want to close this ticket?')">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\money-transfer\resources\views/support/ticket.blade.php ENDPATH**/ ?>