...
<body>
    <div class="email-container">
        ...
        <p>Hello <?php echo e($bankAccount->user->name); ?>,</p>
        ...
        <div class="account-details">
            ...
            <p style="margin-bottom: 0;"><strong>Expected Arrival:</strong> <?php echo e($estimatedArrival); ?></p>
        </div>
        ...
        <div class="steps">
            ...
            <div class="step">
                ...
                <div class="step-content">
                    ...
                    For testing purposes, the amounts sent are: <strong>$<?php echo e(number_format($microAmounts['amount1'], 2)); ?></strong> and <strong>$<?php echo e(number_format($microAmounts['amount2'], 2)); ?></strong>
                </div>
            </div>
        ...
        <a href="<?php echo e(route('bank-accounts.verify-form', $bankAccount)); ?>" class="verification-link">
        ...
        <div class="amounts-highlight">
            ...
            <div class="amounts-box">
                <div class="amount-item">
                    ...
                    <span class="amount-value">$<?php echo e(number_format($microAmounts['amount1'], 2)); ?></span>
                </div>
                <div class="amount-item">
                    <span class="amount-label">Second Amount:</span>
                    <span class="amount-value">$<?php echo e(number_format($microAmounts['amount2'], 2)); ?></span>
                </div>
            </div>
        ...
        <div class="footer">
            ...
            <p>&copy; <?php echo e(date('Y')); ?> SwiftPay. All rights reserved.</p>
        </div>
    </div>
</body>
</html><?php /**PATH C:\xampp\htdocs\money-transfer\WebProject\resources\views/email/micro-transfer-verification.blade.php ENDPATH**/ ?>