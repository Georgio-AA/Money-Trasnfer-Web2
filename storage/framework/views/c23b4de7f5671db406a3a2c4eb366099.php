        ...
        <div class="content">
            ...
            <div class="section">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value"><?php echo e($userEmail); ?></span>
                </div>
                <?php if($userPhone): ?>
                <div class="info-row">
            ...
            <div class="section">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value amount-highlight">$<?php echo e(number_format($cardAmount, 2)); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Submission Date:</span>
                    <span class="info-value"><?php echo e(date('F d, Y \a\t g:i A')); ?></span>
                </div>
            </div>
            ...
            <div style="text-align: center;">
                <a href="<?php echo e($reviewLink); ?>" class="cta-button">Review Request in Dashboard</a>
            </div>
...
<?php /**PATH C:\XAMPP\htdocs\money-transfer2\WebProject\resources\views/emails/card-request-admin.blade.php ENDPATH**/ ?>