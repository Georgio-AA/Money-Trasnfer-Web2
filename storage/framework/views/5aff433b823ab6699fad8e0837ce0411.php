...
<form class="search-bar" method="GET" action="<?php echo e(route('admin.users.index')); ?>">
<input type="text" name="search" placeholder="Search by name, email, or phone..." value="<?php echo e(request('search')); ?>">
<select name="role">
...
<tr style="<?php echo e(($user->status ?? 'active') === 'blocked' ? 'background-color: #fee2e2;' : ''); ?>">
...
<td><span class="badge badge-<?php echo e($user->is_verified ? 'verified' : 'unverified'); ?>"><?php echo e($user->is_verified ? 'Verified' : 'Unverified'); ?></span></td>
<td><?php echo e($user->created_at->format('M d, Y')); ?></td>
<td>
<div class="action-links">
<a href="<?php echo e(route('admin.users.show', $user->id)); ?>">View</a>
...
<?php /**PATH C:\XAMPP\htdocs\money-transfer2\WebProject\resources\views/admin/users/index.blade.php ENDPATH**/ ?>