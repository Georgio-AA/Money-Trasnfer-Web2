    ...
    <div class="container">
        ...
        <div class="card-request-form-wrapper">
            <div class="form-card">
                ...
                <form method="POST" action="<?php echo e(route('card.request.store')); ?>" enctype="multipart/form-data" class="card-request-form">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-section-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="read-only-field">
                                <input type="text" id="balance" readonly value="$<?php echo e(number_format($userBalance, 2)); ?>" class="readonly-input">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="read-only-field">
                                <input type="text" id="card_amount" readonly value="$<?php echo e(number_format($userBalance, 2)); ?>" class="readonly-input">
                            </div>
...
<?php /**PATH C:\XAMPP\htdocs\money-transfer2\WebProject\resources\views/card/request.blade.php ENDPATH**/ ?>