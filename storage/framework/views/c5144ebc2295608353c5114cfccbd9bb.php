...
<div class="value"><?php echo e($stats['high_value_count']); ?></div>
</div>
<div class="stat-card alert">
<h3>Flagged Users</h3>
<div class="value"><?php echo e($stats['flagged_users']); ?></div>
</div>
<div class="stat-card info">
<h3>Pending Review</h3>
<div class="value"><?php echo e($stats['pending_review']); ?></div>
</div>
<div class="stat-card alert">
<h3>Limit Violations</h3>
<div class="value"><?php echo e($stats['limit_violations']); ?></div>
</div>
</div>
...
<?php if($highValueTransfers->count() > 0): ?>
...
<tbody>
<?php $__currentLoopData = $highValueTransfers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transfer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<tr>
...
<td><span class="badge badge-<?php echo e($transfer->status === 'completed' ? 'success' : ($transfer->status === 'pending' ? 'warning' : 'info')); ?>"><?php echo e(ucfirst($transfer->status)); ?></span></td>
<td><?php echo e($transfer->created_at->format('M d, Y H:i')); ?></td>
<td>
<a href="<?php echo e(route('admin.transfers.show', $transfer->id)); ?>" class="btn btn-sm btn-primary">View</a>
<button onclick="openFlagModal(<?php echo e($transfer->id); ?>)" class="btn btn-sm btn-danger">Flag</button>
</td>
</tr>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</tbody>
</table>
<div style="margin-top: 20px;"><?php echo e($highValueTransfers->links()); ?></div>
<?php else: ?>
...
<tbody>
<?php $__currentLoopData = $suspiciousUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<tr>
<td>#<?php echo e($user->id); ?></td>
<td><?php echo e($user->name); ?></td>
<td><?php echo e($user->email); ?></td>
<td><span class="badge badge-danger"><?php echo e($user->transfer_count); ?> transfers</span></td>
<td>
<a href="<?php echo e(route('admin.users.show', $user->id)); ?>" class="btn btn-sm btn-primary">View Profile</a>
<a href="<?php echo e(route('admin.transfers.index')); ?>?user_id=<?php echo e($user->id); ?>" class="btn btn-sm btn-secondary">View Transfers</a>
</td>
</tr>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</tbody>
...
<tbody>
<?php $__currentLoopData = $limitExceeded; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<tr>
<td>#<?php echo e($user->id); ?></td>
<td><?php echo e($user->name); ?></td>
<td><?php echo e($user->email); ?></td>
<td><span class="badge badge-danger">$<?php echo e(number_format($user->daily_total, 2)); ?></span></td>
<td>
<a href="<?php echo e(route('admin.users.show', $user->id)); ?>" class="btn btn-sm btn-primary">View Profile</a>
...
<tr>
<td><span class="badge badge-warning"><?php echo e(ucfirst(str_replace('_', ' ', $alert['type']))); ?></span></td>
<td>#<?php echo e($alert['transfer_id']); ?></td>
<td>$<?php echo e(number_format($alert['amount'], 2)); ?></td>
<td><?php echo e($alert['reason']); ?></td>
<td><span class="badge badge-<?php echo e($alert['status'] === 'resolved' ? 'success' : 'warning'); ?>"><?php echo e(ucfirst(str_replace('_', ' ', $alert['status']))); ?></span></td>
<td><?php echo e(\Carbon\Carbon::parse($alert['flagged_at'])->format('M d, Y H:i')); ?></td>
</tr>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</tbody>
</table>
...
<div class="alert-box alert-info" style="margin-bottom: 20px;">
<a href="<?php echo e(route('admin.audit-log')); ?>" class="btn btn-primary">Open Full Audit Log with Filters</a>
</div>
...
<?php /**PATH C:\xampp\htdocs\money-transfer\WebProject\resources\views/admin/compliance.blade.php ENDPATH**/ ?>