    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="account-card">
                <div><strong>Bank:</strong> <?php echo e($bankAccount->bank_name); ?></div>
                <div><strong>Account:</strong> ****<?php echo e(substr($bankAccount->account_number, -4)); ?></div>
                <div><strong>Currency:</strong> <?php echo e($bankAccount->currency); ?></div>
            </div>
            <p style="margin: 20px 0;">
                <a class="cta" href="<?php echo e($verifyUrl); ?>">Verify this bank account</a>
            </p>
            <p class="meta">This link expires <?php echo e(optional($bankAccount->verification_expires_at)->diffForHumans() ?? 'in 7 days'); ?>.</p>
...
<?php /**PATH C:\xampp\htdocs\money-transfer\WebProject\resources\views/email/bank-account-verification.blade.php ENDPATH**/ ?>